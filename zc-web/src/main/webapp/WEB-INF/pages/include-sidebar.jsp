            ...
            <li class="list-group-item tree-closed">
                ...
                <ul style="margin-top:10px;display:none;">
                    <li style="height:30px;">
                        <a href="admin/page/query"><i class="glyphicon glyphicon-user"></i> 用户维护</a>
                    </li>
                    <li style="height:30px;">
                        <a href="to/role/page"><i class="glyphicon glyphicon-king"></i> 角色维护</a>
                    </li>
                    <li style="height:30px;">
                        <a href="/to/menu/page"><i class="glyphicon glyphicon-lock"></i> 菜单维护</a>
                    </li>
                </ul>
            </li>
            <li class="list-group-item tree-closed">
